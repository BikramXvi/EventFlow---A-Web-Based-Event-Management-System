<%-- WEB-INF/pages/shared/_sidebarAttendee.jsp --%>
<div class="sidebar">
  ...
  <nav class="sidebar-nav">
    <ul class="sidebar-menu">
      <li><a href="${pageContext.request.contextPath}/attendee/dashboard" ${activePage == 'dashboard' ? 'class="active"' : ''}>
      ...
      <li><a href="${pageContext.request.contextPath}/attendee/events" ${activePage == 'events' ? 'class="active"' : ''}>
      ...
      <li><a href="${pageContext.request.contextPath}/attendee/myregistrations" ${activePage == 'myregistrations' ? 'class="active"' : ''}>
      ...
      <li><a href="${pageContext.request.contextPath}/attendee/profile" ${activePage == 'profile' ? 'class="active"' : ''}>
  ...
  <div class="sidebar-footer">
    <div class="sidebar-avatar">${sessionScope.userName != null ? sessionScope.userName.substring(0,2).toUpperCase() : 'AT'}</div>
    <div>
